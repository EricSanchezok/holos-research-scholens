...
async function seedProject(tmpDir: string, opts?: { empty?: boolean }) {
  ...
  for (const dir of ["ideas", "plans", "experiments", "claims", "exhibits", "manuscripts", "submissions"]) {
  ...
  const ideas: IdeaYaml[] = [
    ...
    },
    {
      ...
      round: 1,
      selected_by: "user",
      selected_date: "2026-02-10T00:00:00Z",
  ...
  const claims: ClaimYaml[] = [
    {
      ...
      status: "supported",
      evidence: [{ ref: "exp_001" }, { ref: "exp_002" }],
      caveats: [],
      paper_section: "5.1",
      created: "2026-03-01T00:00:00Z",
    },
    {
      ...
      title: "Method claim",
      status: "supported",
      evidence: [{ ref: "exp_003", strength: "strong" }],
      caveats: [],
      paper_section: "5.2",
    ...
    {
      id: "claim_003",
      title: "Ablation claim A",
      status: "weak",
      evidence: [{ ref: "exp_004", strength: "weak" }],
  ...
  const exhibits: ExhibitYaml[] = [
    {
      ...
      kind: "table",
      status: "approved",
      sources: { experiments: ["exp_003"], claims: ["claim_002"] },
      created: "2026-03-18T00:00:00Z",
    },
    {
      id: "exh_002",
      title: "Ablation figure",
      kind: "figure",
      status: "draft",
      sources: { experiments: ["exp_004"], claims: ["claim_003"] },
      created: "2026-03-22T00:00:00Z",
    },
  ];
  ...
  await ResearchTimeline.append({
    ...
    from: "proposed",
    to: "selected",
    summary: "Selected as main direction",
  });
  await ResearchTimeline.append({
    type: "focus.changed",
    phase: "explore",
    to: "explore",
    summary: "Entered explore phase",
  });
  await ResearchTimeline.append({
    type: "focus.changed",
    phase: "experiment",
    from: "ground",
    to: "experiment",
    summary: "Advanced to experiment",
  });
